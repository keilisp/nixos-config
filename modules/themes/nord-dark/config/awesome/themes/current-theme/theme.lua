...
lain.widget.mpd(
{
  settings = function()
	...
	widget:set_markup(markup.font(theme.font, markup("#a3be8c", artist) .. markup("#8fbcbb", title)))
  end
}
)
...
lain.widget.net(
{
  settings = function()
	...
	markup.font(
	theme.font,
	markup("#8fbcbb", " " .. string.format("%06.1f", net_now.received)) ..
