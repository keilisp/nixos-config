...
theme.fg_focus = "#feacd0"
theme.fg_urgent = "#000000"
theme.bg_normal = "#000000"
theme.bg_focus = "#181a20"
theme.bg_urgent = "#29aeff"
    ...
    lain.widget.net(
    {
        settings = function()
            widget:set_markup(
                markup.font(
                    theme.font,
                    markup("#29aeff", " " .. string.format("%06.1f", net_now.received)) ..
                        " " .. markup("#feacd0", " " .. string.format("%06.1f", net_now.sent) .. " ")
                )
            )
        end
    }
