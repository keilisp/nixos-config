...
local theme = {}
theme.dir = os.getenv("HOME") .. "/.config/awesome/themes/powerarrow-modus-operandi"
theme.wallpaper = theme.dir .. "/wall.png"
-- theme.font = "Hack Bold 8"
-- theme.font = "Hack Bold Italic 8"
-- theme.font = "Hack Italic 8"
-- theme.font = "Hack 8"
theme.font = "IBM Plex Mono 8"
-- theme.taglist_font = "Hack Bold 9"
-- theme.taglist_font = "Hack Bold Italic 9"
-- theme.taglist_font = "Hack Italic 9"
-- theme.taglist_font = "Hack 9"
theme.taglist_font = "IBM Plex Mono 9"
theme.fg_normal = "#000000"
theme.fg_focus = "#721045"
-- theme.fg_focus = "#093060"
theme.fg_urgent = "#ffffff"
theme.bg_normal = "#ffffff"
theme.bg_focus = "#f0f0f0"
theme.bg_urgent = "#093060"
-- theme.bg_urgent = "#721045"
theme.border_width = dpi(2)
theme.border_normal = "#000000"
theme.border_focus = "#721045"
-- theme.border_focus = "#8f0075"
...
theme.mpd =
    lain.widget.mpd(
    {
        settings = function()
            ...
            widget:set_markup(markup.font(theme.font, markup("#0030a6", artist) .. markup("#721045", title)))
        end
    }
)
    ...
    lain.widget.net(
    {
        settings = function()
            widget:set_markup(
                markup.font(
                    theme.font,
                    markup("#0030a6", " " .. string.format("%06.1f", net_now.received)) ..
                        " " .. markup("#721045", " " .. string.format("%06.1f", net_now.sent) .. " ")
                )
            )
        end
    }
