...
lain.widget.weather(
{
  city_id = 707099, -- placeholder (Kalush)
...
function theme.at_screen_connect(s)
  ...
  s.mywibox:setup {
	...
	s.mytasklist, -- Middle widget
	{
	  ...
	  arrow("alpha", "#A77AC4"),
	  wibox.container.background(wibox.container.margin(wibox.widget { keyboardicon, keyboardlayout, layout = wibox.layout.align.horizontal}, 4, 8), "#A77AC4"),
	  arrow("#A77AC4", "#7197E7"),
	  ...
	  arrow("#7197E7", "#A77AC4"),
	  wibox.container.background(
	  wibox.container.margin(wibox.widget {memicon, mem.widget, layout = wibox.layout.align.horizontal}, 2, 3),
	  "#A77AC4"
	  ),
	  arrow("#A77AC4", "#7197E7"),
	  wibox.container.background(
	  wibox.container.margin(wibox.widget {cpuicon, cpu.widget, layout = wibox.layout.align.horizontal}, 3, 4),
	  "#7197E7"
	  ),
	  --arrow("#A77AC4", "#A77AC4"),
	  ...
	  arrow("#A77AC4", "#7197E7"),
	  wibox.container.background(
	  wibox.container.margin(wibox.widget {baticon, bat.widget, layout = wibox.layout.align.horizontal}, 3, 3),
	  "#7197E7"
	  ),
	  arrow("#7197E7", "#A77AC4"),
	  wibox.container.background(
